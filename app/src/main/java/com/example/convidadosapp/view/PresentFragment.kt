...
import com.example.convidadosapp.databinding.FragmentGalleryBinding
...
class PresentFragment : Fragment(), IGuestListener {
    ...
    override fun onResume() {
        super.onResume()
        guestsViewModel.load(GuestConstants.FILTER.PRESENTE)
    }
